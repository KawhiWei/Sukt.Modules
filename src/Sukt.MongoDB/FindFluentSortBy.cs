...
namespace Sukt.MongoDB
{
    public static class FindFluentSortBy<TEntity, TProjection>
    {
        ...
        public static IOrderedFindFluent<TEntity, TProjection> OrderBy(IFindFluent<TEntity, TProjection> findFluent, string propertyName, SortDirectionEnum sortDirection)
        {
        ...
        public static IOrderedFindFluent<TEntity, TProjection> ThenBy(IOrderedFindFluent<TEntity, TProjection> orderedFind, string propertyName, SortDirectionEnum sortDirection)
        {
            propertyName.NotNullOrEmpty("propertyName");
            var keySelector = GetKeySelector(propertyName);
            return sortDirection == SortDirectionEnum.Ascending
